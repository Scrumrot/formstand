...
_Last updated: 2026-09-18 (formstand 0.20.0, formstand-cli 0.20.0)._
...
- **Generated tests — shipped 2026-09-18 (v1).** `--tests
  vitest|jest|playwright` emits a spec beside the component from the same
