...
// Trimmed to the variants the demos (and the CLI's generated forms, which
// the tests typecheck against these components) actually render; restore
// destructive/secondary from stock shadcn if a demo needs them.
